...
public class Model {
	...
	public Model() {
		...
		this.verticiIdMap = new HashMap<Integer,Player>();
		this.dao.listAllPlayers(verticiIdMap);
	}
	...
	public void creaGrafo(Match m) {
		...
		Graphs.addAllVertices(this.grafo, this.dao.getVertici(m,  verticiIdMap));
		
		for(Adiacenza a : dao.getAdiacenze(m, verticiIdMap)) {
			if(a.getPeso() >= 0) {
				//p1 meglio di p2
